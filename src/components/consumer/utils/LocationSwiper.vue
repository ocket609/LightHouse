    ...
    areaData: [
      {
        ...
        imageSrc: '/LightHouse/location/pic-north-lighthouse-3.jpg',
        alt: '新北市富貴角燈塔',
        link: '#'
      },
      {
        ...
        imageSrc: '/LightHouse/location/pic-north-lighthouse-4.jpg',
        alt: '桃園市白沙岬燈陶塔',
        link: '#'
      },
      {
        ...
        imageSrc: '/LightHouse/location/pic-north-lighthouse-2.jpg',
        alt: '新北市三貂角燈塔',
        link: '#'
      }
    ]
    ...
    areaData: [
      {
        ...
        imageSrc: '/LightHouse/location/pic-sorth-lighthouse-1.jpg',
        alt: '台南市國聖港燈塔',
        link: '#'
      },
      {
        ...
        imageSrc: '/LightHouse/location/pic-sorth-lighthouse-2.jpg',
        alt: '高雄燈塔（旗后燈塔）',
        link: '#'
      },
      {
        ...
        imageSrc: '/LightHouse/location/pic-sorth-lighthouse-3.jpg',
        alt: '屏東鵝鑾鼻燈塔',
        link: '#'
      }
    ]
    ...
    areaData: [
      {
        ...
        imageSrc: '/LightHouse/location/pic-east-lighthouse-1.jpg',
        alt: '台東縣綠島燈塔',
        link: '#'
      }
    ]
    ...
    areaData: [
      {
        ...
        imageSrc: '/LightHouse/location/pic-wast-lighthouse-1.jpg',
        alt: '彰化縣芳苑燈塔',
        link: '#'
      }
    ]
...
<template>
  <swiper :spaceBetween="30" :breakpoints="breakpoints" class="mySwiper">
    <swiper-slide v-for="(lighthouse, index) in filteredLighthouses[0]?.areaData" :key="index">
      <div class="card bg-transparent" style="overflow: hidden">
        <div class="card-body p-0">
          <div
            class="card-title ps-6 pb-12 bottom-0 text-white mb-0 w-100"
          ...
          <!-- <a
            href="#"
            class="btn btn-dark position-absolute end-0 text-white bottom-0 px-6 py-14 rounded-0 d-none d-md-block fs-9 fs-md-6"
            style="z-index: 999"
            >MORE</a
          > -->
          <RouterLink
